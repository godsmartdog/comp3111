...
- The application has a user-friendly interface through both JavaFX UI and Console UI.
...
- `ConsoleUI` supports Student/Staff console operations.
- `AuthorConsoleUI2` supports Author console operations.
- `LibrarianConsoleUI3` supports Librarian console operations.
